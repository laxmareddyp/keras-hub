...
class T5GemmaRMSNormalization(keras.layers.Layer):
    """RMS normalization layer for T5Gemma model.
    
    This layer implements RMS (Root Mean Square) normalization, which is used
    in Gemma 2 models instead of traditional Layer Normalization.
    """
